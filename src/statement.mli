(** Most of these methods take their names from standard OCaml methods over maps. cf.
    ...
    (An important aspect of the behaviour of this API is the {{!reso} resolution of ambiguous words}
    in parsed commands. See more details at the bottom of this file.) *)
...
(** [flag fl stmt] finds the flag by the name of [fl], {{!reso} resolves} it if necessary, and
    produces the payload there of, if any.
    ...
    {- [Some (Payload str)], indicating flag [fl] was present and became resolved to the payload
       [str]. This can involve resolution of the word immediately following [fl]. }} *)
...
(** {2:reso Note: Resolution of ambiguous words }
    ...
    positioned, {e that access will result in the datastructure changing} — to prevent the word
