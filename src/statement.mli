...
(** [flag fl stmt] finds the flag by the name of [fl], {{!reso} resolves} it if
    ...
    {ul {- [None], indicating flag [fl] was not present at all. } {- [Some Empty],
    indicating flag [fl] was present, but resolved to having no payload. } {- [Some
    (Payload str)], indicating flag [fl] was present and became resolved to the payload
...
(** {2:reso Note: Resolution of ambiguous words }
    ...
    {[ (* FIXME: `flag` doesn't actually work this way ... *) (* Yields zero positionals,
