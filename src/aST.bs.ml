type 'a unresolved = Unresolved | Resolved of 'a | Absent [@@bs.deriving jsConverter]

type flag = {name : string; mutable payload : string unresolved}
[@@bs.deriving jsConverter]

type arg = Positional of string | Flag of flag [@@bs.deriving jsConverter]

type statement = {count : int; cmd : string; mutable args : arg array}
[@@bs.deriving jsConverter]

type t = {statements : statement array} [@@bs.deriving jsConverter]
